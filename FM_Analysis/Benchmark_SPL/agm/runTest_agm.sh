...
arr=("experiments_agm/fsm/fsm_agm_1.txt" "experiments_agm/fsm/fsm_agm_2.txt" "experiments_agm/fsm/fsm_agm_3.txt" "experiments_agm/fsm/fsm_agm_4.txt" "experiments_agm/fsm/fsm_agm_5.txt" "experiments_agm/fsm/fsm_agm_6.txt");

rm ./log4j/*.log
rm ./experiments_agm/fsm/fsm_*.ot
rm ./experiments_agm/fsm/fsm_*.sul
rm ./experiments_agm/fsm/fsm_*.infer
rm ./experiments_agm/fsm/fsm_*.final
rm ./experiments_agm/fsm/fsm_*.reval

logdir=log_experiments_agm$(date +"%Y%m%d_%H%M%S_%N")
...
mkdir $logdir/
mv ./log4j $logdir/
mv ./experiments_agm/fsm/fsm_*.ot  $logdir/
mv ./experiments_agm/fsm/fsm_*.sul  $logdir/
mv ./experiments_agm/fsm/fsm_*.infer  $logdir/
mv ./experiments_agm/fsm/fsm_*.final  $logdir/
mv ./experiments_agm/fsm/fsm_*.reval  $logdir/
