...
for an_spl in "aerouc5" "cpterminal" "minepump"; do
   ...
   for idx in {00..30}; do
      ls -1 $an_spl/products/products_all/*_kiss.txt | java -cp learnFFSM.jar uk.le.ac.prioritize.PrtzProducts -shuffle -fm $an_spl/model.xml -gmdp          2> $an_spl/emse/recover/gmdp_dis_$an_spl.err 1> $an_spl/emse/recover/gmdp_dis_$an_spl.txt
      ls -1 $an_spl/products/products_all/*_kiss.txt | java -cp learnFFSM.jar uk.le.ac.prioritize.PrtzProducts -shuffle -fm $an_spl/model.xml                2> $an_spl/emse/recover/lmdp_dis_$an_spl.err 1> $an_spl/emse/recover/lmdp_dis_$an_spl.txt
      ls -1 $an_spl/products/products_all/*_kiss.txt | java -cp learnFFSM.jar uk.le.ac.prioritize.PrtzProducts -shuffle -fm $an_spl/model.xml -gmdp -similar 2> $an_spl/emse/recover/gmdp_sim_$an_spl.err 1> $an_spl/emse/recover/gmdp_sim_$an_spl.txt
      ls -1 $an_spl/products/products_all/*_kiss.txt | java -cp learnFFSM.jar uk.le.ac.prioritize.PrtzProducts -shuffle -fm $an_spl/model.xml       -similar 2> $an_spl/emse/recover/lmdp_sim_$an_spl.err 1> $an_spl/emse/recover/lmdp_sim_$an_spl.txt
