...
for idx_PROD_I in range(len(prodOrder)):
	for idx_PROD_J in range(idx_PROD_I,len(prodOrder)):
		...
		bashCommand = "java -cp ./learnFFSM.jar uk.le.ac.prioritize.CalculateDissimilarity ./"+SPL_NAME+"/products_all/"+PROD_I+"_kiss.txt ./"+SPL_NAME+"/products_all/"+PROD_J+"_kiss.txt -fm ./"+SPL_NAME+"/model.xml"
